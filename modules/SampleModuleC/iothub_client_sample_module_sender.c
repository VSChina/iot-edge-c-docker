...
void iothub_client_sample_module_sender(void)
{
    ...
    connectionString = getenv("EdgeHubConnectionString");
    if (connectionString == NULL)
    {
        printf("NULL EdgeHubConnectionString\n");
        return;
    }

    printf("ConnectionString['EdgeHubConnectionString'] sucessfully consumed\n");
